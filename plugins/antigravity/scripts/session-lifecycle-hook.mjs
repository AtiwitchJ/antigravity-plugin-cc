...
function main() {
  ...
  if (eventName === "SessionStart") emitOutput({ hook: "antigravity.SessionStart", workspaceRoot: resolveWorkspaceRoot(cwd), timestamp: nowIso() });
  else if (eventName === "SessionEnd") emitOutput({ hook: "antigravity.SessionEnd", workspaceRoot: resolveWorkspaceRoot(cwd), timestamp: nowIso() });
}
main();